...
<table border="1" align="center" style="font-weight:bold;border:1px solid white;color:white;height:200px;width:900px;font-family:Javanese Text">
<tr>
...
for row in res:
	...
	print "<td>",row[5],"</td>"
	print "<td>",row[4],"</td>"
	print "<td><a href='cancelappointcode.py?id="+str(row[0])+"&s="+str(row[3])+"'>Update</a></td></tr>"
print """
</table>
</div>
</div>
