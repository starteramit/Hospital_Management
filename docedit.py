    ...
    <nav class="col-sm-2 d-none d-md-block bg-light sidebar"style="background-color:#ffc85d;">
	  ...
	  <div class="row" align="center"><img src="images/user.png" style="width:180px;height:150px;"/></div>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="docchangepass.py" style="color:blue;text-align:center;font-size:25px;font-family:Gabriola;font-weight:bold;text-decoration:underline;">
...
em=data.getvalue('id')
cur=con.cursor()
q="select * from tbl_doctor where email='"+em+"'"
cur.execute(q)
res=cur.fetchall()
for r in res:
 print"""
 ...
 <body>
 <form action="doceditcode.py" method="post">
 ...
 <br/>
 <br/>
 <b style="color:white;font-family:Gabriola;font-size:20px;">Specialization</b>
 """
 print '<input type="text" name="special"  class="form-control" value="'+r[6]+'"/>'
 print """
 <br/>
 <b style="color:white;font-family:Gabriola;font-size:20px;">Experience</b>
 """
 print '<input type="text" name="ex"  class="form-control" value="'+r[7]+'"/>'
 print """
 <br/>
 <b style="color:white;font-family:Gabriola;font-size:20px;">Fees</b>
 """
 print '<input type="text" name="fee"  class="form-control" value="'+r[8]+'"/>'
 print """
 <br/>
 <b style="color:white;font-family:Gabriola;font-size:20px;">Address</b>
 """
 print '<input type="text" name="text" class="form-control" value="'+r[9]+'"/>'
 print """
 <br/>
 <b style="color:white;font-family:Gabriola;font-size:20px;">Timing</b>
 """
 print '<input type="text" value="'+r[10]+'" class="form-control" name="time"/>'
 print """
 <br/>
