...
for r in res:
 ...
 print "<tr><td>Specialization</td><td>",r[6],"</td></tr>"
 print "<tr><td>Experience</td><td>",r[7],"</td></tr>"
 print "<tr><td>Fees</td><td>",r[8],"</td></tr>"
 print "<tr><td>Address</td><td>",r[9],"</td></tr>"
 print "<tr><td>Timing</td><td>",r[10],"</td></tr>"
 print "<tr><td colspan='2' align='center'><a href='docedit.py?id="+em+"'>Edit Profile</a></td></tr>"
print """
</div>
</div>
</div>
