...
<div class="col-md-4">
<h1 class="text-center" style="color:black;font-family:Javanese Text">Patient Registration</h1>
<br/>
...
<br/>
<b style="color:black;font-family:Gabriola;font-size:20px;">Mobile Number</b>
<input type="password" name="number" class="form-control" placeholder="Enter Your Number!!"/>
<br/>
